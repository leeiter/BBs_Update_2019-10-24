...
public class BBsServiceV3 {
	...
	public void viewText(long bs_idpk) {
		...
		if(bbsDTO == null) {
			...
			System.out.println("==============================================");
			System.out.print("제목 : " + bbsDTO.getBs_subject());
			System.out.print("작성 : " + bbsDTO.getBs_writer());
			System.out.print("작성일 : " + bbsDTO.getBs_date());
			System.out.print("작성시각 : " + bbsDTO.getBs_time() + "\n");
			System.out.println("----------------------------------------------");
